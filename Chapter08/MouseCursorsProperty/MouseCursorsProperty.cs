...
namespace MouseCursorsProperty
{
    class MouseCursorsProperty:Form
    {
        private Label[] acntl = new Label[28];
        ...
        public MouseCursorsProperty()
        {
            ...
            Text = "Mouse Coursors Using Cursor Property";
            for (int i = 0; i < 28; i++)
            {
                acntl[i]=new Label();
                acntl[i].Parent = this;
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            {
                acntl[i].Bounds=Rectangle.FromLTRB((i%4)*ClientSize.Width/4,(i/4)*ClientSize.Height/7,(i%4+1) * ClientSize.Width / 4, (i / 4+1) * ClientSize.Height / 7);
            }
        }
    }
}
